...
describe("Card", () => {
  ...
  it("has an artCropUri", () => {
    const uri =
      "https://img.scryfall.com/cards/art_crop/front/7/f/7f9a24dc-8bc3-4528-8780-57fb108fdfbf.jpg?1557576823";
  ...
  describe("guessName", () => {
    ...
    it("can guess either or both halves of a split card", () => {
      ...
      const card = new Card({
        name: fullname,
        card_faces: [{ name: names[0] }, { name: names[1] }],
      });
  ...
  describe("getNamesForFace", () => {
    ...
    ["Admiral Beckett Brass", "Academy Ruins", "Baron Von Count"].forEach((name) => {
